...
-- D-45: inputs key uses the external smelt.<path> dep (intermediate.int_customer_orders),
-- not the internal CTE name (customer_metrics). customer_metrics runs as-written.
