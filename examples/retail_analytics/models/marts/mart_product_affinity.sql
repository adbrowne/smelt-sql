...
FROM smelt.ref('stg_order_items') AS a
INNER JOIN smelt.ref('stg_order_items') AS b
    ON a.order_id = b.order_id AND a.product_id < b.product_id
INNER JOIN smelt.ref('stg_products') AS pa ON a.product_id = pa.product_id
INNER JOIN smelt.ref('stg_products') AS pb ON b.product_id = pb.product_id
