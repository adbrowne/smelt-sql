...
INNER JOIN smelt.ref('stg_customers') AS c ON o.customer_id = c.customer_id
INNER JOIN smelt.ref('stg_stores') AS s ON o.store_id = s.store_id
LEFT JOIN smelt.ref('stg_order_items') AS oi ON o.order_id = oi.order_id
GROUP BY
