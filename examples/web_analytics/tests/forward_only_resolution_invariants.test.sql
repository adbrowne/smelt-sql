...
test:
  ...
  inputs:
    silver_sessions:
      ...
      # Session C: zero signed-in events — forward_only_amplitude_id stays NULL at
    ...
    silver_events_parsed:
      ...
      - {event_id: 3, device_id: 2, user_id: 200,  amplitude_id: 'u:200', event_ts: '2026-04-01 11:02:00', event_date: '2026-04-01', event_name: 'login',     platform: 'web', url: 'https://example.com/login'}
      - {event_id: 4, device_id: 2, user_id: null, amplitude_id: 'd:2',   event_ts: '2026-04-01 11:05:00', event_date: '2026-04-01', event_name: 'page_view', platform: 'web', url: 'https://example.com/'}
      - {event_id: 5, device_id: 2, user_id: 201,  amplitude_id: 'u:201', event_ts: '2026-04-01 11:08:00', event_date: '2026-04-01', event_name: 'login',     platform: 'web', url: 'https://example.com/login'}
      # Session C events — all anonymous
      - {event_id: 6, device_id: 3, user_id: null, amplitude_id: 'd:3',   event_ts: '2026-04-01 12:01:00', event_date: '2026-04-01', event_name: 'page_view', platform: 'web', url: 'https://example.com/'}
      - {event_id: 7, device_id: 3, user_id: null, amplitude_id: 'd:3',   event_ts: '2026-04-01 12:09:00', event_date: '2026-04-01', event_name: 'page_view', platform: 'web', url: 'https://example.com/'}
  expect:
    - {session_id: 'sa', forward_only_amplitude_id: 'u:100'}
    - {session_id: 'sb', forward_only_amplitude_id: 'u:201'}  # the LATER signed-in user wins, not the earlier (user_id 200)
