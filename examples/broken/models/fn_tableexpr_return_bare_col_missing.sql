...
-- `smelt.functions.<name>(...)` call in FROM position. The caller writes
-- `SELECT missing_col FROM smelt.functions.add_margin_p17(...)`, but the
...
SELECT missing_col
FROM smelt.functions.add_margin_p17(
