...
-- The chain is:
--   `outer_call(y) AS (smelt.models.middle(y))`
--   `middle(z) AS (smelt.models.inner_unary(z))`
...
smelt.define middle(z) AS (smelt.models.inner_unary(z))
smelt.define outer_call(y) AS (smelt.models.middle(y))

SELECT smelt.models.outer_call(1) AS threaded
