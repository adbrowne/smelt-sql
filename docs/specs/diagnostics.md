...
- **All twelve succession-grain codes are specified and unimplemented.** No classifier, technique,
  tombstone ledger, or diagnostic dispatch exists yet for `SuccessionWindowFunctionNotLead`,
