...
- **Implementation status.** The surface, diagnostics, and resolution order in this spec are the target contract; landing the parser, proof-consultation, and scan-lowering machinery is tracked in `docs/plans/20260719-prod-w3-adoption.md`.

## References

- **Code**: (not yet landed — see §Known Divergences)
- **Tests**: (not yet landed — see §Known Divergences)
- **User docs**: `docs-site/docs/guide/testing.md` (declarative tests section to be added alongside implementation)
- **Plans (history)**:
