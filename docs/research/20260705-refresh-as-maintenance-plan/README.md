...
| 7 | [`07-example-catalogue.md`](07-example-catalogue.md) | 39 worked examples across constructs × source properties × output shapes × techniques, each with a real-world use case and a machine-scannable header; 17 lift-ready probe cells. Includes Family G — schema evolution (single-field backfill as the 2×2's left column). | ~940 |
