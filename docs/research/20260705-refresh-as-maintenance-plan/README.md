...
| 7 | [`07-example-catalogue.md`](07-example-catalogue.md) | 34 worked examples across constructs × source properties × output shapes × techniques, each with a real-world use case and a machine-scannable header; 15 lift-ready probe cells. | ~740 |
