...
| [`docs/plans/20260707-maintenance-plan-spec-alignment.md`](20260707-maintenance-plan-spec-alignment.md) | **Maintenance-plan spec alignment** (SA1–SA5) — closes the remaining spec-diff rows of `docs/research/20260705-refresh-as-maintenance-plan/09-spec-readiness.md` §4: demote `batched_models.md`/`keyed_models.md`/`versioned_models.md` to shape profiles (admission as per-cell obligations), the technique-primitive contracts in `model_transforms.md`, the plan-purity invariant in `architecture.md`+`CLAUDE.md`, the `Maintenance*` family in `diagnostics.md`. Docs-only. | pending |
...
> first: spec alignment (SA1–SA5), then implementation (MP1–MP17).
