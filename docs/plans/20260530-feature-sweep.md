...
| `docs/plans/20260604-frontmatter-parity.md` | "frontmatter fragility" — malformed frontmatter silently drops the block / downgrades materialization — BUG-016, 023, 025 | pending |
