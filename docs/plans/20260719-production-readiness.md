...
|----------|------------------|--------|
| [`docs/plans/20260719-prod-w1-fail-loud.md`](20260719-prod-w1-fail-loud.md) | **W1 Fail-loud closure + exit codes** — materialized-view fallback audit/hard-error pin, the 2 `error`-classified Unknown census sites emit real diagnostics, exit-code contract (0/1/2) standardized + documented. | pending |
