...
| [`docs/plans/20260719-prod-w3-adoption.md`](20260719-prod-w3-adoption.md) | **W3 Adoption surface** — `smelt init`, declarative column tests per D3 (proven-property short-circuit + SQL-scan lowering), `smelt list`/`smelt clean`, failure-summary UX. New spec `docs/specs/data_tests.md`. | done (2026-07-20) |
| [`docs/plans/20260719-prod-w5-release-eng.md`](20260719-prod-w5-release-eng.md) | **W5 Release engineering** — UI hardening (localhost-default bind, CORS), CHANGELOG + RELEASING checklist, SECURITY.md, macOS-Intel wheel claim fix, Docker image, Homebrew formula, crates-publishing decision brief + `publish = false` markers. | done (2026-07-20) |
| [`docs/plans/20260719-prod-w6-docs.md`](20260719-prod-w6-docs.md) | **W6 Production docs** — deployment guide, orchestration (cron/Airflow) guide, state & recovery reference, per-command CLI reference, getting-started refresh around `smelt init`. Documents W2/W3 surfaces; phases block rather than speculate. | done (2026-07-20) |
