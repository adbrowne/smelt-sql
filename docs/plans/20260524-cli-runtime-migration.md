...
| 5 — End-to-end CLI ↔ UI parity CI gate: `cargo test -p smelt-runtime --test execute_parity` runs identical fixtures through both entry points. | done | TBD | 2026-06-07 |
