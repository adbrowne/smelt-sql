...
| P2 | Combined fixed-point loop driver in runtime (rounds, growing set, byte-equal convergence, path-then-name order) | done | D-24 (2/5) | feat(runtime): combined SQL-generator + Python fixed-point evaluation loop (D-24) | 2026-06-20 |
