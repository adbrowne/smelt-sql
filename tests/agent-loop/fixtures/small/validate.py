"""Validate small-fixture outputs against acceptance criteria.

Connects to the first .duckdb file in the project root, runs binary checks,
prints a pass/fail line per check, writes ``eval.json`` next to the script,
