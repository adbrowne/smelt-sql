...
**Analyze**
:   Resolve `smelt.<path>` calls to their targets — models, sources, seeds, and functions all follow the same scheme. Infer column types. Validate schemas and detect mismatches. Build the dependency graph.
