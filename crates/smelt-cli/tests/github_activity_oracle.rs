...
/// The findings-handoff drift gates (phases 15 and 16) — split into their
/// own module file to keep this one under the large-file ratchet; they read
/// [`DIVERGENCE_REGISTRY`] from here.
mod github_activity_handoff;
