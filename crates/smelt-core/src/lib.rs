...
pub use config::{
    parse_active_backends, parse_unstable_schema_flag, parse_warehouse_tables, BackendType, Config,
    ConfigError, DataLatency, Grain, Granularity, IncrementalStrategy, Materialization,
    ModelConfig, PartitionGrainConfig, PartitionGrainSafetyOverrides, RefreshStrategy, Target,
    WarehouseTables, Weekday,
};
pub use discovery::{
...
pub use metadata::{
    extract_file_metadata, frontmatter_yaml_text, CheckConfig, CheckSeverity, ColumnMetadata,
    ColumnTest, FileMetadata, MetadataError, ModelMetadata, ModelSection, ReuseConfig, TestConfig,
};
