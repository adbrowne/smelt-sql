...
///
/// Shared by every doc-sync test in this file: extracts the fenced `text`
/// block immediately following `marker` in `diagnostics.md`, compiles
/// `model_sql` against `backend`, and asserts the live `UnsupportedOnBackend`
/// text is byte-identical to the doc's quote.
