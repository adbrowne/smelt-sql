...
pub use queries::project::{
    ...
    project_emitted_name_collisions, project_external_steps, project_paths, project_seeds,
    project_source_diagnostics, project_sources, project_unstable_schema, project_warehouse_tables,
