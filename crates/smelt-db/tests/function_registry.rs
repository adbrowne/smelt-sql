...
// Phase 4 / Phase 3 fixture-backed assertions migrated to
// `crates/smelt-cli/tests/broken_function_diagnostics.rs` in Phase 6.
// The harness there iterates every `examples/broken/models/fn_*.sql`
// fixture and asserts `DiagnosticCode` + message substring.
